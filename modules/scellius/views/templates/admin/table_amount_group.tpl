...
<thead>
  <tr>
    <th>{l s='Customer group' mod='scellius'}</th>
    <th>{l s='Minimum amount' mod='scellius'}</th>
    {if !isset($min_only) || !$min_only}<th>{l s='Maximum amount' mod='scellius'}</th>{/if}
  </tr>
</thead>

<tbody>
  <tr style="background-color: #bebebe;">
    <td>{l s='ALL GROUPS' mod='scellius'}</td>
    <td>
