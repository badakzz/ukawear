...
if (! class_exists('ScelliusResponse', false)) {
    ...
    class ScelliusResponse
    {
        ...
        {
            $this->rawResponse = ScelliusApi::uncharm($params);
        ...
        {
            return in_array($this->transStatus, ScelliusApi::getCancelledStatuses());
        }
        ...
        {
            return in_array($this->transStatus, ScelliusApi::getToValidateStatuses());
        }
        ...
        {
            $currency = ScelliusApi::findCurrencyByNumCode($this->get('currency'));
        ...
        public function getOutputForGateway($case = '', $extra_message = '', $original_encoding = 'UTF-8')
        {
            ...
            $encoding = in_array(Tools::strtoupper($original_encoding), ScelliusApi::$SUPPORTED_ENCODINGS) ?
