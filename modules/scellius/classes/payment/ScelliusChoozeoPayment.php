...
class ScelliusChoozeoPayment extends AbstractScelliusPayment
{
    protected $prefix = 'SCELLIUS_CHOOZEO_';
    ...
    public static function getAvailableOptions($cart = null)
    {
        ...
        $options = @unserialize(Configuration::get('SCELLIUS_CHOOZEO_OPTIONS'));
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['scellius_choozeo_options'] = self::getAvailableOptions($cart);
