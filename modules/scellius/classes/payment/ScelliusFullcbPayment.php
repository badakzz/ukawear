...
class ScelliusFullcbPayment extends AbstractScelliusPayment
{
    const FULLCB_THREE_TIMES_MAX_FEES = 9;
    const FULLCB_FOUR_TIMES_MAX_FEES = 12;

    protected $prefix = 'SCELLIUS_FULLCB_';
    ...
    public static function getAvailableOptions($cart)
    {
        ...
        $options = @unserialize(Configuration::get('SCELLIUS_FULLCB_OPTIONS'));
    ...
    public function getTplVars($cart)
    {
        ...
        $vars['scellius_fullcb_options'] = $options;
