...
class ScelliusRestModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        $sha_key = $test_mode ? Configuration::get('SCELLIUS_RETKEY_TEST') : Configuration::get('SCELLIUS_RETKEY_PROD');
        ...
        if (! ScelliusTools::checkHash($data, $sha_key)) {
            ...
            $this->logger->logError("{$ip} tries to access module/scellius/rest page without valid signature with parameters: " . print_r($data, true));
